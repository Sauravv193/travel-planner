      ...
      <div className="flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8 relative z-10">
        <div className={`auth-glass-card transition-all duration-1000 transform ${showForm ? 'translate-y-0 opacity-100 scale-100' : 'translate-y-10 opacity-0 scale-95'}`}>
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-forest-800 dark:text-white glow-text">Welcome Back</h2>
            <p className="mt-2 text-earth-600 dark:text-night-muted">Sign in to continue your journey across India</p>
          </div>
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-5">
              <div className="animate-fade-in-up" style={{animationDelay: '0.1s'}}>
                <label htmlFor="username" className="block text-sm font-medium text-forest-700 dark:text-night-text mb-2">Username</label>
              ...
              <div className="animate-fade-in-up" style={{animationDelay: '0.15s'}}>
                <label htmlFor="password" className="block text-sm font-medium text-forest-700 dark:text-night-text mb-2">Password</label>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center -mt-3">
                <span className="px-3 text-xs text-earth-500 dark:text-night-muted bg-white dark:bg-night-card">Or continue with</span>
              </div>
            </div>

            <div className="animate-fade-in-up" style={{animationDelay: '0.3s'}}>
              <a href={`${BACKEND_URL}/oauth2/authorization/google`} className="w-full flex items-center justify-center gap-3 px-4 py-3.5 border border-earth-200 dark:border-night-border rounded-xl bg-white/80 dark:bg-night-surface/80 backdrop-blur-sm hover:border-terracotta-300 dark:hover:border-terracotta-500/50 hover:shadow-lg hover:shadow-terracotta-500/10 transition-all duration-300 group">
                ...
                <span className="text-sm font-semibold text-forest-700 dark:text-night-text group-hover:text-terracotta-600 dark:group-hover:text-terracotta-400 transition-colors">Sign in with Google</span>
              </a>
            </div>

            <div className="text-center animate-fade-in-up" style={{animationDelay: '0.35s'}}>
              <Link to="/forgot-password" className="text-sm text-earth-600 dark:text-night-muted hover:text-terracotta-600 dark:hover:text-terracotta-400 transition-colors font-medium">Forgot password?</Link>
            </div>
            ...
            <div className="text-center animate-fade-in-up" style={{animationDelay: '0.4s'}}>
              <p className="text-sm text-earth-600 dark:text-night-muted">
                ...
                <Link to="/signup" className="text-terracotta-600 dark:text-terracotta-400 font-semibold hover:text-terracotta-700 dark:hover:text-terracotta-300 transition-colors">
