            ...
            <div className="flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8 relative z-10">
                <div className={`auth-glass-card transition-all duration-1000 transform ${showForm ? 'translate-y-0 opacity-100 scale-100' : 'translate-y-10 opacity-0 scale-95'}`}>
                    ...
                    <form className="space-y-5" onSubmit={handleSubmit}>
                        {error && (
                            <div className="bg-red-50/80 dark:bg-red-500/10 backdrop-blur-sm border border-red-200 dark:border-red-800/30 rounded-xl px-4 py-3 text-red-700 dark:text-red-400 text-sm font-medium animate-fade-in-up">
                        ...
                        {success && (
                            <div className="bg-green-50/80 dark:bg-green-500/10 backdrop-blur-sm border border-green-200 dark:border-green-800/30 rounded-xl px-4 py-3 text-green-700 dark:text-green-400 text-sm font-medium animate-fade-in-up">
                                <div className="flex items-center">
                                    <svg className="w-5 h-5 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
