    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="mt-4 flex text-sm text-gray-600 justify-center">
          <span className={`font-medium ${
            uploading ? 'text-gray-400' : 'text-pink-600 hover:text-pink-500'
          }`}>
      ...
      <div className="flex justify-end">
        <button
          ...
          className={`inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500 ${
