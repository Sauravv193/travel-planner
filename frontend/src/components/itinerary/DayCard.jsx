            ...
            {day.activities.map((activity, index) => (
              ...
              >
                ...
                <div className="flex-shrink-0 mr-4 relative">
                  <div className="w-14 h-14 bg-gradient-to-br from-pink-400 to-pink-600 rounded-xl flex items-center justify-center text-white font-semibold text-xs shadow-md border-2 border-white">
                ...
                {/* Compact Activity Card */}
                  <div className="bg-gradient-to-br from-gray-50 to-white p-5 rounded-xl border border-gray-200 hover:shadow-lg transition-all duration-300 hover:border-pink-200">
                  ...
                  {activity.tips && activity.tips.length > 0 && (
                    <div className="bg-pink-50 border border-pink-200 rounded-lg p-3 mt-3">
                      <h5 className="font-medium text-pink-800 mb-2 flex items-center text-sm">
                      ...
                      <ul className="space-y-1 text-pink-700 text-xs">
                        ...
                        {activity.tips.length > 2 && (
                          <li className="text-pink-600 font-medium cursor-pointer hover:text-pink-800">
  ...
  return (
    <div className="transform transition-all duration-500">
      ...
      <div className="mb-8">
        ...
        {day.overview && (
          <p className="text-gray-600 text-lg leading-relaxed bg-pink-50 p-4 rounded-lg border-l-4 border-pink-500">
            {day.overview}
          </p>
        )}
      </div>
      ...
      <div className="space-y-8 relative">
        {/* Enhanced Timeline */}
        <div className="absolute left-8 top-0 bottom-0 w-1 bg-gradient-to-b from-pink-500 to-pink-600 rounded-full opacity-30"></div>
        ...
        {day.activities && day.activities.map((activity, index) => (
          ...
          >
            ...
            <div className="flex-shrink-0 mr-6 relative">
              <div className="h-16 w-16 bg-gradient-to-br from-pink-500 to-pink-600 rounded-full flex items-center justify-center text-white font-bold text-xs shadow-lg z-10 border-4 border-white transform hover:scale-110 transition-transform duration-200">
                <div className="text-center">
