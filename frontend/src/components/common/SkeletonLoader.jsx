...
export const SkeletonItinerary = () => (
  <div className="space-y-8 animate-pulse">
    {/* Header Skeleton */}
    <div className="bg-gradient-to-r from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-600 rounded-2xl h-48"></div>
        ...
        {Array.from({ length: 3 }).map((_, index) => (
          <div key={index} className="flex items-start relative">
            ...
            <div className="flex-1 bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden">
              <div className="bg-gray-100 dark:bg-gray-700 p-6 border-b border-gray-200 dark:border-gray-700">
...
export const SkeletonTrip = () => (
  <div className="animate-pulse space-y-4">
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 space-y-4 border border-gray-200 dark:border-gray-700">
  ...
  <div className="animate-pulse space-y-6">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      {Array.from({ length: 3 }).map((_, i) => (
        <div key={i} className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 space-y-3 border border-gray-200 dark:border-gray-700">
    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700">
      ...
      <div className="p-6 space-y-6">
        <div className="border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-lg p-12 text-center">
          <div className="w-12 h-12 bg-gray-200 dark:bg-gray-700 rounded mx-auto mb-4"></div>
