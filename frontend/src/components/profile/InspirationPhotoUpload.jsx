        ...
        <div className="bg-pink-50 dark:bg-pink-900/20 border border-pink-200 dark:border-pink-700 rounded-lg p-4">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center">
              <svg className="w-5 h-5 text-pink-600 dark:text-pink-400 mr-2" fill="currentColor" viewBox="0 0 20 20">
            ...
            <button
              ...
              disabled={uploading}
              className="px-3 py-1 bg-pink-600 text-white rounded-md text-sm font-medium hover:bg-pink-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
      ...
      <div
        ...
        className={`border-2 border-dashed rounded-lg p-8 text-center transition-colors ${
          uploading 
            ...
            : isDragging 
              ? 'border-pink-500 bg-pink-50 dark:bg-pink-900/20 cursor-pointer' 
              : 'border-gray-300 dark:border-gray-600 hover:border-pink-400 dark:hover:border-pink-500 cursor-pointer'
        }`}
      ...
      >
        ...
        <div className="mt-4 flex text-sm text-gray-600 dark:text-gray-400 justify-center">
          <span className={`font-medium ${
            uploading ? 'text-gray-400 dark:text-gray-500' : 'text-pink-600 dark:text-pink-400 hover:text-pink-500 dark:hover:text-pink-300'
          }`}>
